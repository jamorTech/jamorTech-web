    ...
    <div className="mt-20">
      ...
      <div className="max-w-[1000px] mx-auto mt-10">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10 items-center">
          <Image src={waylc} alt="West Africa Young Leadership Conference" className="max-w-full h-auto" />
          <Image src={italk} alt="italkAdventure" className="max-w-full h-auto" />
          <Image src={emadatt} alt="e-medatt" className="max-w-full h-auto" />
          <Image src={malva} alt="malva" className="max-w-full h-auto" />
          <Image src={connectPro} alt="connectPro" className="max-w-full h-auto" />
        </div>
      </div>
    </div>
  );
